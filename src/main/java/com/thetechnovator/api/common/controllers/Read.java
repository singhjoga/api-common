...
public interface Read<T extends IdentifiableEntity<ID>, ID extends Serializable> extends BaseController<T, ID> {
	...
	@ResponseBody
	default ResponseEntity<T> getOne(@PathVariable ID id) {
