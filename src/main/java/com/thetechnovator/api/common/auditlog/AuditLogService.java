...
import com.thetechnovator.api.common.domain.AbstractResource;
import com.thetechnovator.api.common.services.BaseService;
...
public class AuditLogService extends BaseService{
	...
	public String add(String action, AuditableParent auditable, Object id, String details) {
		return add(action,auditable, id, details, null);
	}
	public String add(String action, AuditableParent auditable, Object id, String details, String filter) {
	...
	public List<AuditLog> find(AuditableParent auditable, Object id) {
		return find(auditable,id, null);
	}
	public List<AuditLog> find(AuditableParent auditable, Object id, List<AuditLog> childAuditables) {
	...
	private void addToResult(List<AuditLog> history, AuditableParent auditable, Object id) {
