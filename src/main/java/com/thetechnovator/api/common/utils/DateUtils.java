package com.thetechnovator.api.common.utils;
...
public class DateUtils {
	...
	public static String formatGermanDateTime(Date date) {
		if (date == null) {
			return null;
		}
	...
	public static String formatJsonTimestamp(Date date) {
		if (date == null) {
			return null;
		}
		
		return jsonDateTimeFormat.format(date);
	}
	...
	public static Date toDateFromGermanFormat(String jsonDateTimeString) {
		try {
			return germanDateFormat.parse(jsonDateTimeString);
		} catch (ParseException e) {
			LOG.warn(e.getMessage());
			return null;
		}
